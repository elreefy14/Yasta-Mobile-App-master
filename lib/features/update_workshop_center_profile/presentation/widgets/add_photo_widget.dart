...
@override
  ...
  getIt<UpdateCenterCubit>(). selectedImages.clear();
    super.initState();
  }
  ...
  Future<void> _pickImage() async {
    ...
    if (pickedFile != null) {
      getIt<UpdateCenterCubit>().addImage(imageFile:File(pickedFile.path) );
      setState(() {
        getIt<UpdateCenterCubit>(). selectedImages.add(File(pickedFile.path));
      });
      for (var image in getIt<UpdateCenterCubit>(). selectedImages) {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        getIt<UpdateCenterCubit>(). selectedImages.isEmpty
            ? Wrap(
          spacing: 10,
          runSpacing: 10,
          children: [
