...
class EditWorkshowLogo extends StatefulWidget {
  const EditWorkshowLogo(
  ...
  @override
  State<EditWorkshowLogo> createState() => _EditWorkshowLogoState();
}

class _EditWorkshowLogoState extends State<EditWorkshowLogo> {
  File? selectedImage;
  ...
  Future<void> _pickImage() async {
    ...
    if (pickedFile != null) {
      setState(() {
        ...
        getIt<UpdateCenterCubit>().selectedLogo=selectedImage;
