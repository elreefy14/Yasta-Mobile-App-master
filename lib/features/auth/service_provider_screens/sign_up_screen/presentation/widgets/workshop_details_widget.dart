...
class WorkshopDetailsWidget extends StatefulWidget {
  ...
  @override
  State<WorkshopDetailsWidget> createState() => _WorkshopDetailsWidgetState();
}

class _WorkshopDetailsWidgetState extends State<WorkshopDetailsWidget> {
  Future<void> _pickImage() async {
    ...
    if (pickedFile != null) {
      setState(() {
        getIt<AuthCubit>().selectedLogo = File(pickedFile.path);
      });
    }
  }
      ...
      children: [
        widget.isMandatory == null
            ? TextFormFieldWithMandatoryLabel(
                ...
                controller: getIt<AuthCubit>().WorkshopNameController,
          validator: (value) {
            if (value!.isEmpty) {
        ...
        widget.isMandatory == null
            ? InkWell(
                ...
                child: getIt<AuthCubit>().selectedLogo == null
        ...
        widget.isMandatory == null
            ? TextFormFieldWithMandatoryLabel(
                ...
                controller: getIt<AuthCubit>().WorkshopAddressController,
          validator: (value) {
            if (value!.isEmpty) {
        ...
        verticalSpace(40),
        PhoneNumberInput(
          controller: getIt<AuthCubit>().WorkshopphoneNumberController,
        ...
        TextFormFieldWithMandatoryLabel(
          ...
          hintText: getLang(
              ...
              .toString(),
          controller: getIt<AuthCubit>().WorkshopDescriptionController,
          // minLines: 5,
          validator: (value) {
            if (value!.isEmpty) {
              return getLang(context, "Description").toString();
            }
            return null;
          },
        ),
