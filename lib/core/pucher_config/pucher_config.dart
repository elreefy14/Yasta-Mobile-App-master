...
class PusherConfig {
  ...
  Future<void> initPusher(Function(PusherEvent) onEvent, {required String roomId}) async {
    ...
    try {
      ...
      await _pusher.subscribe(
        channelName: "conversation.${roomId}.auth.${CacheHelper.getdata(key:"id")}",
      );

      log("Subscribed to channel: conversation.${roomId}");
